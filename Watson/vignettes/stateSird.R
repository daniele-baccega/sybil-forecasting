...
dir.create(file.path(covidDir, "Output"))
...
# }
for(i in 1:length(states)) {
  stateSird(states[i], states, covariates, stateInterventions, velocLogCases, stateCovidData, randomForestDeathModel, posteriorSamples, rfError = T)
}
