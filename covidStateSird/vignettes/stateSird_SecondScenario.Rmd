...
outputPath <- file.path(covidDir, "Output_SecondScenario", Sys.Date())
dir.create(file.path(covidDir, "Output_SecondScenario"))
...
for(i in 1:length(states)) {
  ...
  velocLoc <- velocitiesState(stateCovidData_local, states[i], stateInterventions, 
...
# train death model ------------------------------------------------------------
randomForestDeathModel <- deathForest(stateCovidData_local, 
                                      states,
                                      covariates, 
                                      28, 
