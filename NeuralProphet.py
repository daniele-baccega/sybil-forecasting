...
parser.add_argument('--suffix', type=str, default="all", help='Suffix')
...
filename = args.directory + "neural_prophet_data_" + args.suffix + ".csv"
...
forecast_7.to_csv(args.directory + "forecast_7_" + args.suffix + ".csv")
forecast_14.to_csv(args.directory + "forecast_14_" + args.suffix + ".csv")
forecast_21.to_csv(args.directory + "forecast_21_" + args.suffix + ".csv")
forecast_28.to_csv(args.directory + "forecast_28_" + args.suffix + ".csv")
